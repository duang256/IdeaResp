...
public class OrderItem {
    ...
    @Column(name = "product_yidou")
    private Integer productyidou;
    ...
    @Column(name = "total_yidou")
    private Integer totalyidou;
    ...
    public Integer getProductyidou() {
        return productyidou;
    }

    public void setProductyidou(Integer productyidou) {
        this.productyidou = productyidou;
    }

    public Integer getTotalyidou() {
        return totalyidou;
    }

    public void setTotalyidou(Integer totalyidou) {
        this.totalyidou = totalyidou;
    }
