...
public class User {
    ...
    public User(Integer id, String photo, String username, String password, String email, String phone, String question, String answer, Integer role, Date createTime, Date updateTime,Integer yidou) {
        this.id = id;
        this.photo = photo;
